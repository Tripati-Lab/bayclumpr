...
BayesCal <- cal.bayesian(calibrationData = ds, numSavedSteps = 3000, priors = "Weak")
```
...
```{r message=FALSE, warning=FALSE, error =FALSE}
PredsBay <- rec.bayesian(calModel = BayesCal$BLM1_fit_NoErrors, recData = recData, iter = 1000, postcalsamples = 100)
```
