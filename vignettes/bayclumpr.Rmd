...
```{r}
recData <- data.frame(Sample = paste("Sample", 1:6), 
                      D47 = c(0.6, 0.7, 0.8, 0.6, 0.7, 0.8), 
                      D47error = c(0.005, 0.005, 0.005, 0.01, 0.01, 0.01),
                      N = c(2, 2, 2, 2, 2, 2),
...
```{r message=FALSE, warning=FALSE, error =FALSE}
PredsBay <- rec.bayesian(calModel = BayesCal$BLM1_fit_NoErrors, recData = recData, iter = 1000)
```
